...
math_df = {
    ...
    "Formula/Equation/Symbol": ["Quadratic formula: x = (-b ± sqrt(b^2 - 4ac)) / (2a)\nBinomial theorem: (a + b)^n = sum(k=0 to n) binom(n, k) a^(n-k) b^k\nExponential properties: a^m * a^n = a^(m+n), (a^m) / (a^n) = a^(m-n)",
                                 "Linear equation: y = mx + b\nQuadratic equation: ax^2 + bx + c = 0\nExponential function: y = ab^x",
                                 "Pythagorean theorem: a^2 + b^2 = c^2\nSine, cosine, tangent definitions: sin θ = opposite / hypotenuse, cos θ = adjacent / hypotenuse, tan θ = opposite / adjacent",
